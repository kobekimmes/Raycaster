...
class Raycast:
    ...
    def showRays(self):
        ...
        for ray in range(self.num_rays):
            ...
            pg.draw.aaline(self.game.screen, (255, 255, 0), (self.game.camera.get_real_pos),
                         (self.game.camera.x + (sin_a * depth * res), self.game.camera.y + (cos_a * depth * res)), 2)
    ...
    def show3D(self):
        for i, ray_length in enumerate(self.ray_distances):

            scale = self.game.WIDTH // self.num_rays
